...
export default function ProfileSettings() {
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] p-6 flex items-start justify-center">
      <div className="w-full container mx-auto">
        ...
        <div className="bg-[#222222] rounded-2xl px-6 py-5 mb-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-black text-sm font-semibold px-4 py-2 rounded-full transition-colors">
          ...
          <div className="bg-[#2d2d2d] rounded-2xl p-6 w-full max-w-sm shadow-2xl relative">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center pt-1">
                <button
                  onClick={() => setShowPasswordModal(false)}
                  className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold text-sm px-10 py-2.5 rounded-lg transition-colors"
                >
                  Save
                </button>
              </div>

...
export default function ProfileSettings() {
  ...
  return (
    <div className="min-h-screen p-6 flex items-start justify-center">
      <div className="w-full container mx-auto bg-[#181715] p-10 rounded-lg">
        {/* Profile Header Card */}
        <div className=" rounded-2xl px-6 py-5 mb-6 flex items-center justify-between">
        ...
        {/* Form Fields */}
        <div className="rounded-2xl px-6 py-6 space-y-5">
          {/* Full Name */}
          <div>
